...
INSERT INTO inventory_items (
    created_at, updated_at, name, image_url, flavor_text, effect_text, 
...
(NOW(), NOW(), 'Bread Loaf', 'https://crew-points-of-interest.s3.amazonaws.com/health-potion.png', 'A fresh loaf of bread with a golden crust. It smells warm and comforting.', 'Restores 15 health and provides temporary +1 constitution.', 'Common', 'consumable', 0, 0, 0, 15, 0, 0, 0, 0, 'none', 0, 0, 0, 0, 1, 0, 'bread_loaf_001', 0.8, 5, 100, 100, 1, true, 5, true, 0, 1, 1, false, NULL, '{"nourishment": true}', 'golden', 'steam_rise', 'soft_crunch', '{"health": 15, "constitution": 1}'),
(NOW(), NOW(), 'Antidote', 'https://crew-points-of-interest.s3.amazonaws.com/antidote.png', 'A clear liquid with a bitter taste. It neutralizes most common poisons.', 'Removes poison effects and provides poison resistance for 1 hour.', 'Uncommon', 'consumable', 0, 0, 0, 0, 0, 0, 0, 0, 'none', 0, 0, 0, 0, 0, 0, 'antidote_001', 0.3, 75, 100, 100, 3, true, 5, true, 0, 1, 1, false, NULL, '{"poison_removal": true, "poison_resistance": 3600}', 'clear', 'gentle_glow', 'liquid_slosh', '{"poison_resistance": 3600}'),
(NOW(), NOW(), 'Invisibility Potion', 'https://crew-points-of-interest.s3.amazonaws.com/invisibility-potion.png', 'A shimmering potion that seems to bend light around it. It makes you feel lighter.', 'Makes you invisible for 30 seconds.', 'Rare', 'consumable', 0, 0, 0, 0, 0, 0, 0, 0, 'none', 0, 0, 0, 0, 0, 0, 'invisibility_potion_001', 0.4, 200, 100, 100, 5, true, 3, true, 300, 1, 1, false, NULL, '{"invisibility": 30}', 'shimmering', 'light_bend', 'magical_whisper', '{"stealth": 30}'),
