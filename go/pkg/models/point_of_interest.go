...
type PointOfInterest struct {
	...
	MarkerCategory             PointOfInterestMarkerCategory `json:"markerCategory" gorm:"column:marker_category"`
	MarkerCategoryDerived      bool                          `json:"-" gorm:"-"`
...
func (p *PointOfInterest) BeforeSave(tx *gorm.DB) error {
	...
	p.MarkerCategory = NormalizePointOfInterestMarkerCategory(string(p.MarkerCategory))
	if p.Lat != "" && p.Lng != "" {
