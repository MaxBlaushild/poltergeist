...
type QuestArchetypeChallenge struct {
	...
	FailureUnlockedNodeID *uuid.UUID          `json:"failureUnlockedNodeId,omitempty" gorm:"column:failure_unlocked_node_id;type:uuid"`
	FailureUnlockedNode   *QuestArchetypeNode `json:"failureUnlockedNode,omitempty" gorm:"foreignKey:FailureUnlockedNodeID"`
}
