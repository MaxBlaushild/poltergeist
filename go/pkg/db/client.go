...
type client struct {
	...
	monsterActionHandle               *monsterActionHandler
	...
	inventoryItemStatsHandle          *inventoryItemStatsHandler
	...
	userStatsHandle                   *userStatsHandler
}
...
func NewClient(cfg ClientConfig) (DbClient, error) {
	...
	return &client{
		...
		monsterActionHandle:               &monsterActionHandler{db: db},
		...
		inventoryItemStatsHandle:          &inventoryItemStatsHandler{db: db},
		...
		userStatsHandle:                   &userStatsHandler{db: db},
	}, nil
}
...
func (c *client) UserStats() UserStatsHandle {
	return c.userStatsHandle
}
...
func (c *client) InventoryItemStats() InventoryItemStatsHandle {
	return c.inventoryItemStatsHandle
}
...
func (c *client) MonsterAction() MonsterActionHandle {
	return c.monsterActionHandle
}
