...
type client struct {
	...
	pointOfInterestExpositionSeedConfigHandle *pointOfInterestExpositionSeedConfigHandle
	pointOfInterestShopkeeperSeedConfigHandle *pointOfInterestShopkeeperSeedConfigHandle
...
func NewClient(cfg ClientConfig) (DbClient, error) {
	...
	return &client{
		...
		pointOfInterestExpositionSeedConfigHandle: &pointOfInterestExpositionSeedConfigHandle{db: db},
		pointOfInterestShopkeeperSeedConfigHandle: &pointOfInterestShopkeeperSeedConfigHandle{db: db},
...
func (c *client) QuestGenerationJob() QuestGenerationJobHandle {
	return c.questGenerationJobHandle
}
...
func (c *client) QuestArchetypeItemReward() QuestArchetypeItemRewardHandle {
...
func (c *client) PointOfInterestExpositionSeedConfig() PointOfInterestExpositionSeedConfigHandle {
	return c.pointOfInterestExpositionSeedConfigHandle
}

func (c *client) PointOfInterestShopkeeperSeedConfig() PointOfInterestShopkeeperSeedConfigHandle {
	return c.pointOfInterestShopkeeperSeedConfigHandle
}
...
func (c *client) ZoneSeedJob() ZoneSeedJobHandle {
	return c.zoneSeedJobHandle
}
...
func (c *client) ScenarioTemplateGenerationDraft() ScenarioTemplateGenerationDraftHandle {
	return c.scenarioTemplateGenerationDraftHandle
}
...
func (c *client) ZoneFlavorGenerationJob() ZoneFlavorGenerationJobHandle {
	return c.zoneFlavorGenerationJobHandle
}

func (c *client) ZoneTagGenerationJob() ZoneTagGenerationJobHandle {
	return c.zoneTagGenerationJobHandle
}

func (c *client) BaseDescriptionGenerationJob() BaseDescriptionGenerationJobHandle {
	return c.baseDescriptionGenerationJobHandle
}
...
func (c *client) MonsterTemplate() MonsterTemplateHandle {
	return c.monsterTemplateHandle
}
...
func (c *client) MonsterBattleParticipant() MonsterBattleParticipantHandle {
	return c.monsterBattleParticipantHandle
}

func (c *client) MonsterBattleInvite() MonsterBattleInviteHandle {
	return c.monsterBattleInviteHandle
}

func (c *client) Scenario() ScenarioHandle {
	return c.scenarioHandle
}
