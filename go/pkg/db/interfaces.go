...
type ZoneImportHandle interface {
	Create(ctx context.Context, item *models.ZoneImport) error
	Update(ctx context.Context, item *models.ZoneImport) error
...
type ChallengeGenerationJobHandle interface {
	Create(ctx context.Context, job *models.ChallengeGenerationJob) error
	Update(ctx context.Context, job *models.ChallengeGenerationJob) error
...
type ZoneFlavorGenerationJobHandle interface {
	Create(ctx context.Context, job *models.ZoneFlavorGenerationJob) error
	Update(ctx context.Context, job *models.ZoneFlavorGenerationJob) error
...
type MonsterBattleHandle interface {
	...
	RecordLastAction(ctx context.Context, battleID uuid.UUID, action models.MonsterBattleLastAction) error
