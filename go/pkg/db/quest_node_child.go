...
func (h *questNodeChildHandle) DeleteByNextNodeID(ctx context.Context, nodeID uuid.UUID) error {
	return h.db.WithContext(ctx).Where("next_quest_node_id = ?", nodeID).Delete(&models.QuestNodeChild{}).Error
}
