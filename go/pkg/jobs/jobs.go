...
const (
	...
	GenerateExpositionTemplateSpeakerPortraitsTaskType = "generate_exposition_template_speaker_portraits"
...
type GenerateExpositionTemplateSpeakerPortraitsTaskPayload struct {
