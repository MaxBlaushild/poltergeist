...
type SecretConfig struct {
	DbPassword                 string
	SlackScorekeeperToken      string
	SlackScorekeeperWebhookUrl string
}
...
func ParseFlagsAndGetConfig() (*Config, error) {
	...
	return &Config{
		Secret: SecretConfig{
			...
			SlackScorekeeperToken:      os.Getenv("SLACK_SCOREKEEPER_TOKEN"),
			SlackScorekeeperWebhookUrl: os.Getenv("SLACK_SCOREKEEPER_WEBHOOK_URL"),
		},
		Public: publicCfg,
	}, nil
}
