...
func (c *gameEngineClient) AwardQuestTurnInRewards(ctx context.Context, userID uuid.UUID, questID uuid.UUID, teamID *uuid.UUID) (goldAwarded int, itemAwarded *models.ItemAwarded, err error) {
	...
	// Quest rewards currently only include gold; inventory items are awarded via challenges.
	itemAwarded = nil
