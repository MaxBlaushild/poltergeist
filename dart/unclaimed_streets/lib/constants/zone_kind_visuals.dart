...
const Map<String, ZoneKindVisualProfile> _zoneKindVisualProfiles = {
  ...
  'coast': ZoneKindVisualProfile(
    label: 'Coast',
    icon: Icons.beach_access,
    atmosphereLabel: 'Salt and surf',
    focusLabel: 'Hidden caches',
    lineJoin: 'round',
    discoveredFillOpacity: 0.35,
    undiscoveredFillOpacity: 0.65,
    ...
    outerLineBlur: 1.2,
    undiscoveredOuterLineBlur: 1.8,
    panelSurface: Color(0xFF1D2A31),
    panelBorder: Color(0xFFD8C28C),
    panelAccent: Color(0xFF7FC8D8),
    panelText: Color(0xFFF3F5F3),
    panelSubtext: Color(0xFFD2E2E5),
    panelChipBackground: Color(0xFF293B42),
    panelChipText: Color(0xFFE2F0F2),
    panelShadow: Color(0xFF121A1E),
  ),
  'riverlands': ZoneKindVisualProfile(
    label: 'Riverlands',
    icon: Icons.timeline,
    atmosphereLabel: 'Branching currents',
    focusLabel: 'Travel routes',
    lineJoin: 'round',
    discoveredFillOpacity: 0.38,
    undiscoveredFillOpacity: 0.68,
    outerLineWidth: 7.5,
    ...
    outerLineBlur: 1.5,
    undiscoveredOuterLineBlur: 2.0,
    panelSurface: Color(0xFF1E2A24),
    panelBorder: Color(0xFFC8D6A2),
    panelAccent: Color(0xFF77C2AA),
    panelText: Color(0xFFF1F6EE),
    panelSubtext: Color(0xFFD1E1D6),
    panelChipBackground: Color(0xFF2B3D35),
    panelChipText: Color(0xFFE3EFCF),
    panelShadow: Color(0xFF131A16),
  ),
  'tidal-flats': ZoneKindVisualProfile(
    label: 'Tidal Flats',
    icon: Icons.water,
    atmosphereLabel: 'Shifting tides',
    focusLabel: 'Timed scavenging',
    lineJoin: 'round',
    discoveredFillOpacity: 0.4,
    undiscoveredFillOpacity: 0.7,
    outerLineWidth: 7.7,
    ...
    outerLineBlur: 1.6,
    undiscoveredOuterLineBlur: 2.2,
    panelSurface: Color(0xFF27302C),
    panelBorder: Color(0xFFE2D2A2),
    panelAccent: Color(0xFF96C7B0),
    panelText: Color(0xFFF5F3EA),
    panelSubtext: Color(0xFFDDE2D7),
    panelChipBackground: Color(0xFF37423D),
    panelChipText: Color(0xFFE7EBCF),
    panelShadow: Color(0xFF171C19),
  ),
  'sunken-ruins': ZoneKindVisualProfile(
    label: 'Sunken Ruins',
    icon: Icons.account_balance,
    atmosphereLabel: 'Drowned relics',
    focusLabel: 'Treasure rich',
    lineJoin: 'bevel',
    discoveredFillOpacity: 0.39,
    undiscoveredFillOpacity: 0.69,
    ...
    outerLineBlur: 1.5,
    undiscoveredOuterLineBlur: 2.1,
    panelSurface: Color(0xFF202B33),
    panelBorder: Color(0xFFD4BC8F),
    panelAccent: Color(0xFF87BFD0),
    panelText: Color(0xFFF3F3F0),
    panelSubtext: Color(0xFFD4DDE0),
    panelChipBackground: Color(0xFF2D3D47),
    panelChipText: Color(0xFFE7E2CC),
    panelShadow: Color(0xFF141A1E),
  ),
  'port': ZoneKindVisualProfile(
    label: 'Port',
    icon: Icons.local_shipping,
    atmosphereLabel: 'Harbor intrigue',
    focusLabel: 'Scenario rich',
    lineJoin: 'miter',
    discoveredFillOpacity: 0.34,
    undiscoveredFillOpacity: 0.64,
    outerLineWidth: 8.0,
    undiscoveredOuterLineWidth: 8.7,
    innerLineWidth: 2.2,
    undiscoveredInnerLineWidth: 2.0,
    outerLineOpacity: 0.23,
    undiscoveredOuterLineOpacity: 0.44,
    ...
    outerLineBlur: 0.9,
    undiscoveredOuterLineBlur: 1.4,
    panelSurface: Color(0xFF252933),
    panelBorder: Color(0xFFD1B386),
    panelAccent: Color(0xFF8FA9C8),
    panelText: Color(0xFFF4F1EB),
    panelSubtext: Color(0xFFD7DCE4),
    panelChipBackground: Color(0xFF343C49),
    panelChipText: Color(0xFFE8DFC8),
    panelShadow: Color(0xFF161920),
  ),
  'cave': ZoneKindVisualProfile(
    label: 'Cave',
    icon: Icons.terrain,
    atmosphereLabel: 'Echoing dark',
    focusLabel: 'Mining rich',
    lineJoin: 'bevel',
    discoveredFillOpacity: 0.36,
    undiscoveredFillOpacity: 0.67,
    ...
    outerLineBlur: 1.1,
    undiscoveredOuterLineBlur: 1.7,
    panelSurface: Color(0xFF23252C),
    panelBorder: Color(0xFFC9C4B6),
    panelAccent: Color(0xFF99A2B7),
    panelText: Color(0xFFF1F2F5),
    panelSubtext: Color(0xFFD4D8E0),
    panelChipBackground: Color(0xFF323641),
    panelChipText: Color(0xFFE1E5EE),
    panelShadow: Color(0xFF15171C),
  ),
  'tundra': ZoneKindVisualProfile(
    label: 'Tundra',
    icon: Icons.ac_unit,
    atmosphereLabel: 'Frozen expanse',
    focusLabel: 'Harsh survival',
    lineJoin: 'round',
    discoveredFillOpacity: 0.31,
    undiscoveredFillOpacity: 0.62,
    outerLineWidth: 7.7,
    ...
    outerLineBlur: 1.3,
    undiscoveredOuterLineBlur: 1.9,
    panelSurface: Color(0xFF202A31),
    panelBorder: Color(0xFFD8E3EA),
    panelAccent: Color(0xFFAECEDD),
    panelText: Color(0xFFF3F8FB),
    panelSubtext: Color(0xFFD6E1E7),
    panelChipBackground: Color(0xFF2E3A43),
    panelChipText: Color(0xFFE3EFF4),
    panelShadow: Color(0xFF141A1E),
  ),
  'reef': ZoneKindVisualProfile(
    label: 'Reef',
    icon: Icons.water,
    atmosphereLabel: 'Bright shallows',
    focusLabel: 'Treasure rich',
    lineJoin: 'round',
    discoveredFillOpacity: 0.39,
    undiscoveredFillOpacity: 0.69,
    ...
    outerLineBlur: 1.6,
    undiscoveredOuterLineBlur: 2.2,
    panelSurface: Color(0xFF182E31),
    panelBorder: Color(0xFFE4C28A),
    panelAccent: Color(0xFF72D0C8),
    panelText: Color(0xFFF2F8F7),
    panelSubtext: Color(0xFFD1E6E3),
    panelChipBackground: Color(0xFF234145),
    panelChipText: Color(0xFFE4F1D4),
    panelShadow: Color(0xFF0F1C1E),
  ),
  'plains': ZoneKindVisualProfile(
    label: 'Plains',
    icon: Icons.grass,
    atmosphereLabel: 'Open horizon',
    focusLabel: 'Roaming routes',
    lineJoin: 'round',
    discoveredFillOpacity: 0.33,
    undiscoveredFillOpacity: 0.62,
    outerLineWidth: 7.2,
    ...
    outerLineBlur: 0.9,
    undiscoveredOuterLineBlur: 1.4,
    panelSurface: Color(0xFF2A291A),
    panelBorder: Color(0xFFE0CC84),
    panelAccent: Color(0xFFBFD36C),
    panelText: Color(0xFFF7F3E5),
    panelSubtext: Color(0xFFE2DAC0),
    panelChipBackground: Color(0xFF3C3A24),
    panelChipText: Color(0xFFEDF0BF),
    panelShadow: Color(0xFF1A180F),
  ),
  'jungle': ZoneKindVisualProfile(
    label: 'Jungle',
    icon: Icons.park,
    atmosphereLabel: 'Dense overgrowth',
    focusLabel: 'Herbalism rich',
    lineJoin: 'round',
    discoveredFillOpacity: 0.43,
    undiscoveredFillOpacity: 0.72,
    outerLineWidth: 7.9,
    undiscoveredOuterLineWidth: 8.8,
    innerLineWidth: 2.8,
    ...
    outerLineOpacity: 0.22,
    undiscoveredOuterLineOpacity: 0.43,
    innerLineOpacity: 0.97,
    outerLineBlur: 1.9,
    undiscoveredOuterLineBlur: 2.5,
    panelSurface: Color(0xFF18281D),
    panelBorder: Color(0xFF9DC679),
    panelAccent: Color(0xFF5CC08A),
    panelText: Color(0xFFF0F8E8),
    panelSubtext: Color(0xFFCBE1CA),
    panelChipBackground: Color(0xFF24372A),
    panelChipText: Color(0xFFDDF0C4),
    panelShadow: Color(0xFF0F1712),
  ),
};
