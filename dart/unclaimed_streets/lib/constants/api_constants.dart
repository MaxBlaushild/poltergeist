class ApiConstants {
  ...
  static String chooseScenarioRewardItemEndpoint(String scenarioId) =>
      '/sonar/scenarios/$scenarioId/rewards/choose-item';
  static String chooseChallengeRewardItemEndpoint(String challengeId) =>
      '/sonar/challenges/$challengeId/rewards/choose-item';
