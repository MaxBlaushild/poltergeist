...
class _LayoutShellState extends State<LayoutShell> {
  ...
  void _openCharacterProfileDrawer(User user) {
    ...
    _sideDrawerKey.currentState?.showProfile(user);
    _openDrawer();
  }
    ...
    return _LogoutCleaner(
      ...
      child: Scaffold(
        ...
        onEndDrawerChanged: (isOpened) {
          ...
          final pendingProfileUser = _pendingProfileUser;
          if (pendingProfileUser != null) {
            _sideDrawerKey.currentState?.showProfile(pendingProfileUser);
            _pendingProfileUser = null;
          }
