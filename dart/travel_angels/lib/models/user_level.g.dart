...
UserLevel _$UserLevelFromJson(Map<String, dynamic> json) => UserLevel(
      ...
      experiencePointsOnLevel:
          UserLevel._experiencePointsOnLevelFromJson(json['experiencePointsOnLevel']),
      totalExperiencePoints:
          UserLevel._totalExperiencePointsFromJson(json['totalExperiencePoints']),
      levelsGained: UserLevel._levelsGainedFromJson(json['levelsGained']),
      experienceToNextLevel:
          UserLevel._experienceToNextLevelFromJson(json['experienceToNextLevel']),
    );
