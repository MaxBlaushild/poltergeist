  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: const Icon(Icons.close, color: AppColors.graphiteInk),
          ...
          if (_isExporting)
            ...
            TextButton(
              ...
              child: Text(
                'Export',
                style: TextStyle(
                  color: _metadata != null ? AppColors.softRealBlue : Colors.grey,
                  fontWeight: FontWeight.w600,
                ),
              ),
            ),
                                      ...
                                      child: OutlinedButton.icon(
                                        ...
                                        style: OutlinedButton.styleFrom(
                                          backgroundColor: _customAudioPath != null && !_isRecording
                                              ? AppColors.softRealBlue.withValues(alpha: 0.1)
                                              : null,
                                        ),
                                      ),
                                    ),
                                ...
                                if (_customAudioPath != null) ...[
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: AppColors.softRealBlue.withValues(alpha: 0.1),
                                      borderRadius: BorderRadius.circular(8),
                                    ),
                                    child: Row(
                                      children: [
                                        Icon(Icons.check_circle, color: AppColors.softRealBlue, size: 20),
                                        const SizedBox(width: 8),
                                        Expanded(
                                          child: Text(
                                            _isRecording 
