...
export default function HowToMeasure() {
  return (
    <div className="card max-w-2xl space-y-6 p-8">
      <h1 className="font-display text-2xl font-bold text-reef-ink">How to measure your tank</h1>
      ...
      <ul className="list-inside list-disc space-y-2 marker:text-reef-coral text-reef-ink/80">
