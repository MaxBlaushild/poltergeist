...
// GM console tab: an in-console preview of the projector view, plus a link to
// this Toast's standalone, no-auth /broadcast page for casting to a TV.
